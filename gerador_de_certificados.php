...
imagettftext($jpg_image, 35, 0, 500, 1700, $cor, $fonte_padrao, '_____________________________');
imagettftext($jpg_image, 35, 0, 500, 1770, $cor, $fonte_padrao, $assinatura_1_nome);
imagettftext($jpg_image, 35, 0, 500, 1820, $cor, $fonte_padrao, $assinatura_1_funcao);
imagettftext($jpg_image, 35, 0, 1900, 1700, $cor, $fonte_padrao, '_____________________________');
imagettftext($jpg_image, 35, 0, 1900, 1770, $cor, $fonte_padrao, $assinatura_2_nome);
imagettftext($jpg_image, 35, 0, 1900, 1820, $cor, $fonte_padrao, $assinatura_2_funcao);
